...
namespace WPFArrows.Arrows
{
    ...
    public abstract class ArrowBase : Shape
    {
        ...
        /// 整个形状(包含箭头和具体形状)
        /// </summary>
        private readonly PathGeometry _wholeGeometry = new();

        /// <summary>
        /// 除去箭头外的具体形状
        /// </summary>
        private readonly PathFigure _figureConcrete = new();

        /// <summary>
        /// 开始处的箭头线段
        /// </summary>
        private readonly PathFigure _figureStart = new();

        /// <summary>
        /// 结束处的箭头线段
        /// </summary>
        private readonly PathFigure _figureEnd=new();
